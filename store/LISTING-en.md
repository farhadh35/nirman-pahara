...
How to measure, how to tell good cement, steel, brick and sand from bad, why curing decides the strength, what tied reinforcement should look like. 22 chapters, 120 cards, with labelled diagrams drawn in the app itself.
...
This app takes no advertising from cement, steel, brick, tile, paint, contracting or real-estate companies — those are exactly the things it judges.

It is not an engineering test and not legal advice, and it does not represent any government entity. It states what the rule requires and what you observed, separately, so the authority can verify it.
