...
// Release signing details live outside the repository. Without them the build
// still works and falls back to debug signing, so a contributor can build and
// run without the release key — but such a build can never be uploaded, which
